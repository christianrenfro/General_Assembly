...
| Practice | Simple Linear Regression          | [Here](./practice/simple-linear-regression-sacramento.ipynb) |
|          | Simple Linear Regression Solution | [Here](./practice/solution-code/simple-linear-regression-sacramento-solutions.ipynb) |
|          | Regression Review Lab  (HW 6)     | [Here](./practice/linear_regression-review-lab-starter.ipynb) |
|          | Regression Review Lab Solution    | [Here](../../../homework_solns/linear_regression-review-lab-solutions.ipynb) |
|          | Kobe Shot Regularization          | [Here](./practice/kobe-shots-made-regularization-lab.ipynb) |
|          | Kobe Shot Regularization Solution | [Here](./practice/solution-code/kobe-shots-made-regularization-lab-solutions.ipynb) |
